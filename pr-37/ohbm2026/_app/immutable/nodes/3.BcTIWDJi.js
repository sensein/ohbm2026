import{a as n,c as ke,f as p,s as I,e as B}from"../chunks/6CoMxXur.js";import{S as R,s as o}from"../chunks/DC3HxZhE.js";import{bk as S,ag as U,ad as X,$ as Z,Y as t,aY as a,ba as s,aM as c,aj as i,aK as $,b1 as ee}from"../chunks/BZMj-hQ5.js";import{i as M}from"../chunks/Dp63Us4F.js";import{e as Ae}from"../chunks/B4UehGxW.js";import{h as xe}from"../chunks/nZ2prVR8.js";import{d as Se}from"../chunks/NM2QCsQN.js";var Me=p('<h1 class="svelte-cwls5q">About Abstract Atlas</h1>'),Te=p('<h1 class="svelte-cwls5q">About the NeuroScape PubMed Atlas</h1>'),Le=p('<h1 class="svelte-cwls5q">About the OHBM 2026 Atlas</h1>'),Pe=p(`<p class="svelte-cwls5q">The cross-conference landing page — currently Abstract Atlas — puts the
				...
				the subsites are independently rebuildable and link back to this hub.</p>`),Ne=p(`<p class="svelte-cwls5q">A reduced-functionality browse of the NeuroScape PubMed 1999–2023
				...
				OHBM 2026 abstracts overlaid on this same UMAP.</p>`),De=p(`<p class="svelte-cwls5q">Reading 3,000+ abstracts to find the ones you care about isn't realistic for most
				...
				abstract's claims and figures, and a lightweight saved-list export.</p>`),Oe=p(`<aside class="tldr svelte-cwls5q"><ul class="svelte-cwls5q"><li class="svelte-cwls5q"><strong class="svelte-cwls5q">Source.</strong> <code class="svelte-cwls5q">src/ohbm2026/fetch/graphql_api.py</code> exports three queries: <code class="svelte-cwls5q">ABSTRACT_IDS_QUERY</code> (accepted
										...
										next run's diff base.</li></ul></aside>`),Ie=p(`<p>We pull the accepted-abstract corpus from the <a target="_blank" rel="noopener noreferrer" class="svelte-cwls5q">Oxford Abstracts GraphQL API</a>, paginating through every accepted submission. Each record carries
							...
							submissions never reach this site — they're filtered out at this stage.</p> <button type="button" class="tldr-toggle svelte-cwls5q"><span class="caret svelte-cwls5q"> </span> Technical details</button> <!>`,1),Ee=p(`<aside class="tldr svelte-cwls5q"><ul class="svelte-cwls5q"><li class="svelte-cwls5q"><strong class="svelte-cwls5q">Orchestrator.</strong> <code class="svelte-cwls5q">src/ohbm2026/enrich/stage.py</code> walks the accepted corpus, dispatches each record to three
										...
										wall time, and the cmdline that produced it.</li></ul></aside>`),Ce=p(`<p>Each abstract is passed to an LLM (currently <code class="svelte-cwls5q">gpt-5.4-mini</code>) twice:
							...
							checklists, authors) carries no such pill — that text is theirs.</p> <button type="button" class="tldr-toggle svelte-cwls5q"><span class="caret svelte-cwls5q"> </span> Technical details</button> <!>`,1),Be=p(`<aside class="tldr svelte-cwls5q"><ul class="svelte-cwls5q"><li class="svelte-cwls5q"><strong class="svelte-cwls5q">Per-component bundles.</strong> Every abstract is
										...
										zero-copy into a Web Worker on first paint.</li></ul></aside>`),Re=p(`<p>We compute sentence-level embeddings for every abstract using five
							...
							read time, so the UI can show the same corpus through different "lenses".</p> <button type="button" class="tldr-toggle svelte-cwls5q"><span class="caret svelte-cwls5q"> </span> Technical details</button> <!>`,1),Ue=p(`<aside class="tldr svelte-cwls5q"><ul class="svelte-cwls5q"><li class="svelte-cwls5q"><strong class="svelte-cwls5q">Orchestrator.</strong> <code class="svelte-cwls5q">ohbmcli analyze-matrix</code> (wraps <code class="svelte-cwls5q">analyze/runners.py</code>) fans out across 48 (model,
										...
										projects this wide table into per-cell shards keyed by <code class="svelte-cwls5q">&lt;model&gt;_&lt;input&gt;</code>.</li></ul></aside>`),je=p(`<p>For each (model, input) combination we build a UMAP layout
							...
							"lens" rather than just the currently-selected one.</p> <button type="button" class="tldr-toggle svelte-cwls5q"><span class="caret svelte-cwls5q"> </span> Technical details</button> <!>`,1),He=p(`<aside class="tldr svelte-cwls5q"><ul class="svelte-cwls5q"><li class="svelte-cwls5q"><strong class="svelte-cwls5q">Stack.</strong> SvelteKit 2 + Vite 6 + Svelte 5, <code class="svelte-cwls5q">@sveltejs/adapter-static</code> with <code class="svelte-cwls5q">fallback: '404.html'</code> and <code class="svelte-cwls5q">paths.base = $env.BASE_PATH</code>. Plotly via <code class="svelte-cwls5q">plotly.js-gl3d-dist-min</code> (lazy-loaded; only the
										...
										the Stage 4 deep-dive.</li></ul></aside>`),Fe=p(`<p>This site is a static SvelteKit app deployed to GitHub Pages. The data
							...
							also shipped in the tarball.</p> <p class="muted svelte-cwls5q">Source: <a target="_blank" rel="noopener noreferrer" class="svelte-cwls5q">github.com/sensein/ohbm2026</a>. Build provenance is in the footer of every page.</p> <button type="button" class="tldr-toggle svelte-cwls5q"><span class="caret svelte-cwls5q"> </span> Technical details</button> <!>`,1),ze=p('<div class="stage-body svelte-cwls5q"><!></div>'),We=p('<section class="stage svelte-cwls5q"><button type="button" class="stage-header svelte-cwls5q"><span class="caret svelte-cwls5q"> </span> <span class="stage-label svelte-cwls5q"> </span></button> <!></section>'),Ge=p(`<div class="about-page svelte-cwls5q"><nav class="back svelte-cwls5q"><a class="svelte-cwls5q">← back to atlas</a></nav> <header class="svelte-cwls5q"><!> <p class="lead svelte-cwls5q">A search-and-browse interface for every accepted OHBM 2026 abstract. Each abstract
			...
			landing is the only hub that knows about all of them.</p></section> <!></div>`);function $e(se){let E=$({}),v=$({});function te(l){ee(E,{...i(E),[l]:!i(E)[l]})}function j(l){ee(v,{...i(v),[l]:!i(v)[l]})}const h={oxford:{url:"https://app.oxfordabstracts.com/"},umap:{url:"https://arxiv.org/abs/1802.03426"},leiden:{url:"https://www.nature.com/articles/s41598-019-41695-z"},hdbscan:{url:"https://joss.theoj.org/papers/10.21105/joss.00205"},minilm:{url:"https://arxiv.org/abs/2002.10957"},eco:{url:"https://evidenceontology.org/"},openalex:{url:"https://openalex.org/"},neuroscape_repo:{url:"https://github.com/ccnmaastricht/NeuroScape"},neuroscape_paper:{url:"https://apertureneuro.org/article/156380-the-evolving-landscape-of-neuroscience"},repo:{url:"https://github.com/sensein/ohbm2026"}};var W=Ge();xe("cwls5q",l=>{var e=ke(),P=U(e);{var D=T=>{X(()=>{Z.title="About · Abstract Atlas"})},H=T=>{X(()=>{Z.title="About · NeuroScape PubMed Atlas"})},Q=T=>{X(()=>{Z.title="About · OHBM 2026 Atlas"})};M(P,T=>{R==="atlas-root"?T(D):R==="neuroscape"?T(H,1):T(Q,-1)})}n(l,e)});var G=t(W),ae=t(G);a(G);var V=s(G,2),le=t(V);{var ce=l=>{var e=Me();n(l,e)},oe=l=>{var e=Te();n(l,e)},re=l=>{var e=Le();n(l,e)};M(le,l=>{R==="atlas-root"?l(ce):R==="neuroscape"?l(oe,1):l(re,-1)})}c(2),a(V);var K=s(V,2),ie=t(K);{var ne=l=>{var e=Pe();n(l,e)},de=l=>{var e=Ne(),P=s(t(e));c(3),a(e),S(()=>o(P,"href",h.neuroscape_paper.url)),n(l,e)},pe=l=>{var e=De();n(l,e)};M(ie,l=>{R==="atlas-root"?l(ne):R==="neuroscape"?l(de,1):l(pe,-1)})}c(4),a(K);var ve=s(K,2);Ae(ve,0,()=>[{key:"fetch",label:"Stage 1 — Fetch & normalise (Oxford Abstracts → JSON)"},{key:"enrich",label:"Stage 2 — AI enrichment (figures + claims + references)"},{key:"embed",label:"Stage 3 — Embeddings (5 models × per-section)"},{key:"analyse",label:"Stage 4 — Communities + clusters + UMAP"},{key:"ui",label:"Stage 6 — This site"}],l=>l.key,(l,e)=>{var P=We(),D=t(P),H=t(D),Q=t(H,!0);a(H);var T=s(H,2),he=t(T,!0);a(T),a(D);var ue=s(D,2);{var we=J=>{var Y=ze(),me=t(Y);{var ge=w=>{var g=Ie(),d=U(g),y=s(t(d));c(3),a(d);var u=s(d,2),b=t(u),r=t(b,!0);a(b),c(),a(u);var _=s(u,2);{var L=k=>{var A=Oe();n(k,A)};M(_,k=>{i(v)[e.key]&&k(L)})}S(()=>{o(y,"href",h.oxford.url),o(u,"aria-expanded",!!i(v)[e.key]),I(r,i(v)[e.key]?"▾":"▸")}),B("click",u,()=>j(e.key)),n(w,g)},be=w=>{var g=Ce(),d=U(g),y=s(t(d),5),u=s(y,4);c(),a(d);var b=s(d,4),r=t(b),_=t(r,!0);a(r),c(),a(b);var L=s(b,2);{var k=A=>{var m=Ee(),q=t(m),x=s(t(q),8),f=s(t(x),2);c(5),a(x),c(2),a(q),a(m),S(()=>o(f,"href",h.openalex.url)),n(A,m)};M(L,A=>{i(v)[e.key]&&A(k)})}S(()=>{o(y,"href",h.eco.url),o(u,"href",h.openalex.url),o(b,"aria-expanded",!!i(v)[e.key]),I(_,i(v)[e.key]?"▾":"▸")}),B("click",b,()=>j(e.key)),n(w,g)},qe=w=>{var g=Re(),d=U(g),y=s(t(d)),u=s(y,2),b=s(u,2);c(),a(d);var r=s(d,2),_=t(r),L=t(_,!0);a(_),c(),a(r);var k=s(r,2);{var A=m=>{var q=Be(),x=t(q),f=s(t(x),6),C=s(t(f),2),N=s(C,2);c(),a(f);var O=s(f,2),F=s(t(O),4);c(7),a(O);var z=s(O,2),_e=s(t(z));_e.nodeValue=` The MiniLM corpus matrix used
										for in-browser semantic search is composed of
										{intro, methods, results, conclusion}, L2-renormalised, then
										int8-quantised with a global scale = `,c(10),a(z),a(x),a(q),S(()=>{o(C,"href",h.neuroscape_paper.url),o(N,"href",h.neuroscape_repo.url),o(F,"href",h.minilm.url)}),n(m,q)};M(k,m=>{i(v)[e.key]&&m(A)})}S(()=>{o(y,"href",h.minilm.url),o(u,"href",h.neuroscape_paper.url),o(b,"href",h.neuroscape_repo.url),o(r,"aria-expanded",!!i(v)[e.key]),I(L,i(v)[e.key]?"▾":"▸")}),B("click",r,()=>j(e.key)),n(w,g)},fe=w=>{var g=je(),d=U(g),y=s(t(d)),u=s(y,2),b=s(u,2);c(),a(d);var r=s(d,4),_=t(r),L=t(_,!0);a(_),c(),a(r);var k=s(r,2);{var A=m=>{var q=Ue(),x=t(q),f=t(x),C=s(t(f),6);C.textContent="data/outputs/analysis/annotations__<state-key>.{parquet,sqlite}",c(),a(f);var N=s(f,4),O=s(t(N),2);c(9),a(N);var F=s(N,6),z=s(t(F),2);z.textContent="{title, description, focus}",c(3),a(F),c(4),a(x),a(q),S(()=>o(O,"href",h.leiden.url)),n(m,q)};M(k,m=>{i(v)[e.key]&&m(A)})}S(()=>{o(y,"href",h.umap.url),o(u,"href",h.leiden.url),o(b,"href",h.hdbscan.url),o(r,"aria-expanded",!!i(v)[e.key]),I(L,i(v)[e.key]?"▾":"▸")}),B("click",r,()=>j(e.key)),n(w,g)},ye=w=>{var g=Fe(),d=U(g),y=s(t(d));c(),a(d);var u=s(d,2),b=s(t(u));c(),a(u);var r=s(u,2),_=t(r),L=t(_,!0);a(_),c(),a(r);var k=s(r,2);{var A=m=>{var q=He(),x=t(q),f=s(t(x),4),C=s(t(f),14);C.textContent="{ ids, exactness }",c(),a(f);var N=s(f,8),O=s(t(N),18);O.textContent="goto(stash, { replaceState: true })",c(5),a(N),c(6),a(x),a(q),n(m,q)};M(k,m=>{i(v)[e.key]&&m(A)})}S(()=>{o(y,"href",h.minilm.url),o(b,"href",h.repo.url),o(r,"aria-expanded",!!i(v)[e.key]),I(L,i(v)[e.key]?"▾":"▸")}),B("click",r,()=>j(e.key)),n(w,g)};M(me,w=>{e.key==="fetch"?w(ge):e.key==="enrich"?w(be,1):e.key==="embed"?w(qe,2):e.key==="analyse"?w(fe,3):e.key==="ui"&&w(ye,4)})}a(Y),n(J,Y)};M(ue,J=>{i(E)[e.key]&&J(we)})}a(P),S(()=>{o(P,"data-testid",`about-stage-${e.key}`),o(D,"aria-expanded",!!i(E)[e.key]),I(Q,i(E)[e.key]?"▾":"▸"),I(he,e.label)}),B("click",D,()=>te(e.key)),n(l,P)}),a(W),S(()=>o(ae,"href",`${Se}/`)),n(se,W)}export{$e as component};
