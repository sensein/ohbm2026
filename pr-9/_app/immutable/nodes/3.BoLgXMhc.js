import{a as g,f as b,s as P,e as C}from"../chunks/CfsBuQlH.js";import{s as l}from"../chunks/DJqCkxES.js";import{be as S,a8 as de,$ as ve,U as s,aS as t,b4 as e,ae as r,aF as Q,aX as J,ab as R,aH as c}from"../chunks/grBROpRT.js";import{i as D}from"../chunks/BAdNfywN.js";import{e as pe}from"../chunks/C--ridr8.js";import{h as he}from"../chunks/DaX5jQg-.js";import{d as ue}from"../chunks/2eqLJ9U_.js";var we=b(`<aside class="tldr svelte-cwls5q"><ul class="svelte-cwls5q"><li class="svelte-cwls5q"><strong class="svelte-cwls5q">Source.</strong> <code class="svelte-cwls5q">src/ohbm2026/fetch/graphql_api.py</code> exports three queries: <code class="svelte-cwls5q">ABSTRACT_IDS_QUERY</code> (accepted
										...
										logged count.</li> <li class="svelte-cwls5q"><strong class="svelte-cwls5q">Figure assets.</strong> Inline figures stream into <code class="svelte-cwls5q">data/primary/assets/&lt;abstract_id&gt;_&lt;sha12&gt;.&lt;ext&gt;</code> via the <code class="svelte-cwls5q">asset_stem</code> hash; re-runs detect identical
							...
							"lens" rather than just the currently-selected one.</p> <button type="button" class="tldr-toggle svelte-cwls5q"><span class="caret svelte-cwls5q"> </span> Technical details</button> <!>`,1),ke=b(`<aside class="tldr svelte-cwls5q"><ul class="svelte-cwls5q"><li class="svelte-cwls5q"><strong class="svelte-cwls5q">Stack.</strong> SvelteKit 2 + Vite 6 + Svelte 5, <code class="svelte-cwls5q">@sveltejs/adapter-static</code> with <code class="svelte-cwls5q">fallback: '404.html'</code> and <code class="svelte-cwls5q">paths.base = $env.BASE_PATH</code>. Plotly via <code class="svelte-cwls5q">plotly.js-gl3d-dist-min</code> (lazy-loaded; only the
										...
										loaded by the site with zero code changes.</li></ul></aside>`),xe=b(`<p>This site is a static SvelteKit app deployed to GitHub Pages. The data
