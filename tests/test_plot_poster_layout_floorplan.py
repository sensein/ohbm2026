...
@unittest.skip(
    "Parked layout module (Stage 5 — see CLAUDE.md `layout/` parked notice). "
    "Test references `data/embeddings/voyage_stage2_published/clustering_benchmark/"
    "cluster_assignments.json` which is no longer generated by the canonical pipeline. "
    "Revive together with the layout package when a future organizer cycle needs it."
)
